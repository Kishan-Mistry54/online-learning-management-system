<?php 
	...
	{
		$q = "select * from admin_login where password like '".$_REQUEST['txt_old']."' and username like '".$_SESSION['admin']."'";
		if(mysqli_num_rows(mysqli_query($conn,$q))>0)
		{
		 if($_REQUEST['txt_new'] == $_REQUEST['txt_pwd'])
			{
				$q1 = "update admin_login set password = '".$_REQUEST['txt_new']."' where username like '".					$_SESSION['admin']."'";
