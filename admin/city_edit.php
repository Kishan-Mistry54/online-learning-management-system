<?php 
	...
	include('session.php'); 
	$i = $_REQUEST['sid'];
	$q = "select * from city where city_id ='$i'";
	...
	if(isset($_REQUEST['btn_update']))
	{
		...
		$update = "update city set city_name = '$nm' where city_id = '$i'";
						  ...
						  <div class="col-md-12">
							  <div class="form-group">
								<label class="control-label">City Name <span class="required">*</span>
								  ...
								  <input type="text" name="txt_fnm" id="first-name" value = "<?php echo $r1['city_name'];?>"  required="required" class="form-control">
							  </div>
						  </div>
