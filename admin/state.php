...
<?php	
	...
	$insert="insert into state(state_name) values('$name')";
						  ...
						  <div class="col-md-12">
							  <div class="form-group">
								<label class="control-label">State Name <span class="required">*</span>
								  ...
								  <input type="text" name="txt_name" id="first-name" pattern="[A-Za-z]{2,}" title="Only Alphabets.. min 2 char.." required="required" class="form-control" placeholder="State Name">
							  </div>
						  </div>
