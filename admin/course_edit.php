<?php 
	...
	include('session.php'); 
	$i = $_REQUEST['id'];
	$q = "select * from course where cid ='$i'";
	...
	if(isset($_REQUEST['btn_update']))
	{
		...
		$update = "update course set  cname = '$nm' where cid = '$i'";
						  ...
						  <div class="col-md-12">
							  <div class="form-group">
								<label class="control-label">Course Name <span class="required">*</span>
								  ...
								  <input type="text" name="txt_fnm" id="first-name" value = "<?php echo $r1['cname'];?>"  required="required" class="form-control">
							  </div>
						  </div>
